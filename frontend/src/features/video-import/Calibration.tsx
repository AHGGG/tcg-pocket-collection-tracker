...
export function Calibration({
  ...
  return (
    <div className="calibration">
      ...
      <p id="calibration-help">
        Drag a rectangle for <strong>{labels[active].toLowerCase()}</strong>. For the quantity, leave margins and enough width for multi-digit counts and a
        trailing +. Exclude ×, icons and neighboring cards.
      </p>
      <canvas
        ref={canvasRef}
        width={width}
